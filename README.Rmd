...
function to obtain a fit statistic, you can conduct a relative importance analysis.
...
fit statistics that can be dominance analyzed.
...
In being like `apply`, `domin` is agnostic to the fit statistic to use for the 
...
In my view, `domin` is a decision tool for model explanation (i.e., understanding a fitted, pre-selected model) and is not as useful for model selection (i.e., choosing a "final" model) or inference (i.e., significance testing/bootstrapping).  This perspective will guide development of this package's functionality.
