...
The second element of the list is a string that indicates the element of the object _returned by_ the fit statistic extractor function to be used for dominance analysis.  Thus, the fit statistic extractor function should return (or be adapted to return) a named vector or list from which `domin` can select the fit statistic.
