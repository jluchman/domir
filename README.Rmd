...
the `'m` discussed above is dominance analyzed with the McFadden pseudo-$R^2$ 
...
Note that this fit metric produces effectively the same answer as that from the 
