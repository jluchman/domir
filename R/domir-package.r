...
#' variables, predictors, features, parameter estimates) to a predictive model
#' summarize predicted values and separate the effects of correlated inputs
#' on the output (i.e., dependent variables, outcomes, responses).
#' Comparing the returned value, such as a model fit metric or statistic,
#' associated with each input is a common, and generally
#' well accepted, method for determining the relative importance of inputs to
#' predictive models.
#'
...
#' decomposition (Grömping, 2007; Lipovetsky & Conklin, 2001) as one of its
#' methods called general dominance statistics.
#'
#' @references
#' \itemize{
